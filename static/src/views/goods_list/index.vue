    ...
    <el-table
      ...
      <el-table-column :label="$t('table.actions')" align="center" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button type="primary" size="mini" @click="handleUpdate(scope.row)">推荐</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { getList, fetchPv, createArticle, updateArticle } from '@/api/goods'
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['opAt', 'title', 'type', 'importance', 'status']
        const filterVal = ['opAt', 'title', 'type', 'importance', 'status']
